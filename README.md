# Sainsbury's-Preis-Tracker

[![Bright Data](https://img.shields.io/badge/Powered%20by-Bright%20Data-blue?style=flat-square)](https://brightdata.de)
[![Sainsbury's Price Tracker](https://img.shields.io/badge/Sainsbury's%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/sainsburys)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/sainsburys)

Preisverfolgung für Sainsbury's in Echtzeit – die zweitgrößte Supermarktkette im Vereinigten Königreich. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit Bright Data's AI Scraper Builder.

---

## Option 1: Bright Insights – KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/sainsburys)** ist Bright Data's vollständig verwaltete Plattform für Retail Intelligence. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Verfolgen Sie die Lebensmittelpreisinflation** über Kategorien hinweg bei Sainsbury's
...
> **Ab $250/Monat – [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/sainsburys)**

---

## Option 2: Erstellen Sie Ihren eigenen Sainsbury's-Scraper

Keine vorgefertigte Sainsbury's-Scraper-API? Kein Problem. Bright Data's **AI Scraper Builder** generiert in nur wenigen Klicks einen benutzerdefinierten Sainsbury's-Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren Sainsbury's-Scraper in wenigen Minuten

**[Öffnen Sie den Sainsbury's AI Scraper Builder →](https://brightdata.de/products/web-scraper/sainsburys)**
...
- Eine **Web Scraper ID** für Sainsbury's (aus dem obigen Build-Schritt)
...
1. **Klonen Sie dieses repository**
   ...
   ```bash
   git clone https://github.com/bright-data-de/sainsburys-price-tracker.git
   cd sainsburys-price-tracker
   ```
...
3. **Konfigurieren Sie die Zugangsdaten**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder-Dashboard](https://brightdata.de/products/web-scraper/sainsburys)
...
Sobald Ihr Sainsbury's-Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von Sainsbury's-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.sainsburys.co.uk/products/sample-product",
...
Sammeln Sie alle Produkte von einer Sainsbury's-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://sainsburys.co.uk/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.sainsburys.co.uk/products/sample-product",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://sainsburys.co.uk/images/product1.jpg"],
...
inputs = [{"url": "https://www.sainsburys.co.uk/products/sample-product"}]
...
- 🌟 [Sainsbury's Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/sainsburys)
- 🏗️ [Einen Sainsbury's-Scraper erstellen](https://brightdata.de/products/web-scraper/sainsburys)
